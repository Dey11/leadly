...
export function AiAssistDialog({
    ...
    const [generatedFields, setGeneratedFields] = useState<IcpFields | null>(null);
    ...
    const handleGenerate = async () => {
        ...
        try {
            const response = await clientApi.suggestIcp({ description: description.trim() });
    ...
    const meetsMinimum = charCount >= MIN_DESCRIPTION_LENGTH && wordCount >= MIN_WORD_COUNT;
                            ...
                            <div>
                                ...
                                <div className="text-muted-foreground mt-2 flex items-center justify-between text-xs">
                                    <span className={meetsMinimum ? "text-green-600" : ""}>
                                        {wordCount} words · {charCount}/{MAX_DESCRIPTION_LENGTH} chars
                                    </span>
                                    {charCount > MAX_DESCRIPTION_LENGTH * 0.9 ? (
                                        ...
                                        <span>Min: {MIN_WORD_COUNT} words, {MIN_DESCRIPTION_LENGTH} chars</span>
                                    )}
                                </div>
                            </div>
                        ...
                        <div className="space-y-4">
                            <div className="bg-primary/5 border-primary/20 rounded-lg border p-3">
                                <p className="text-foreground text-sm">
                                    ✨ Review and edit the fields below, then apply them to your form.
                                </p>
                            </div>

                            <FieldGroup className="space-y-4">
                                <Field>
                                    <FieldLabel htmlFor="gen-name" className="text-sm font-medium">
                                        ICP Name
                                    </FieldLabel>
                                    <Input
                                        id="gen-name"
                                ...
                                <Field>
                                    <FieldLabel htmlFor="gen-summary" className="text-sm font-medium">
                                        Summary
                                    </FieldLabel>
                                    <Textarea
                                        id="gen-summary"
                                ...
                                <Field>
                                    <FieldLabel htmlFor="gen-persona" className="text-sm font-medium">
                                        Target Persona
                                    </FieldLabel>
                                    <Textarea
                                        id="gen-persona"
                                ...
                                <Field>
                                    <FieldLabel htmlFor="gen-pains" className="text-sm font-medium">
                                        Pain Points
                                    </FieldLabel>
                                    <Textarea
                                        id="gen-pains"
                                ...
                                <Field>
                                    <FieldLabel htmlFor="gen-value" className="text-sm font-medium">
                                        Value Proposition
                                    </FieldLabel>
                                    <Textarea
                                        id="gen-value"
                                ...
                                <Field>
                                    <FieldLabel htmlFor="gen-qualifying" className="text-sm font-medium">
                                        Qualifying Signals
                                    </FieldLabel>
                                    <Textarea
                                        id="gen-qualifying"
                                ...
                                <Field>
                                    <FieldLabel htmlFor="gen-disqualifying" className="text-sm font-medium">
