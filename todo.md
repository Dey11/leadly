...
- routes for email validation

4. logo, favicon
5. the account icon, when i click on it, it should hav a small panel for acc info

- forget pwd full flow
...
- need leadly support email
- forgot pwd needs to connect to leadly email
- research about smtp servers
